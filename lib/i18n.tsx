...
const ru = {
  ...
  marketing: {
    ...
    hintAppOpen: '— уже залогинен, открыл /home). «Скрыть мои IP» работает только при',
    hintEnabled: 'включённой',
    hintIps: 'галочке; IP в поле — через запятую. Колонка «Последний вход» по заведениям — вкладка',
    ...
    hideIpTitle: 'Добавить IP в «Скрыть мои IP» (только этот адрес)',
    hideIp: 'скрыть',
    host: 'Сайт (хост)',
    refresh: 'Обновить',
...
const en: typeof ru = {
  ...
  marketing: {
    ...
    hintAppOpen: '— already signed in, opened /home). “Hide my IPs” applies only when the',
    hintEnabled: 'checkbox is on',
    hintIps: '; IPs in the field are comma-separated. “Last login” by venue is on the',
    ...
    hideIpTitle: 'Add IP to “Hide my IPs” (this address only)',
    hideIp: 'hide',
    host: 'Site (host)',
    refresh: 'Refresh',
